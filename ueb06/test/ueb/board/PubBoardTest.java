...
public class PubBoardTest {
     ...
     * <pre>    private static final BoardCellType[][] START_BOARD = {
    ...
    public void test0Constructor_Default() {
        ...
        assertEquals( SWAMP, board.getCellAtPosition(new Position(2, 0)).getType());
        assertEquals( SWAMP, board.getCellAtPosition(new Position(2, 1)).getType());
        assertEquals( SWAMP, board.getCellAtPosition(new Position(2, 2)).getType());
        assertEquals( SWAMP, board.getCellAtPosition(new Position(2, 3)).getType());
        assertEquals( SWAMP, board.getCellAtPosition(new Position(2, 4)).getType());
