...
import static ueb.board.BoardCellType.CANYON;
import static ueb.board.BoardCellType.SWAMP;

/**
 * Tests for the pathfinder. Published with assignment.
 *
 * @author fme
 */
public class PubPathfinderTest_Floodfill {

    @Test
    public void test0GetPathFromPosToPos_Valid_Straight() {
        Board board =
                new Board(new BoardCellType[][] {
                {SWAMP, CANYON, CANYON}, // x = 0
                {SWAMP, CANYON, CANYON}, // x = 1
                {SWAMP,  SWAMP,  SWAMP}
        });
        PathList result = new Pathfinder().getPathFromPosToPos(new Position(0,0), new Position(2,0),
                board);
    ...
    public void testGetPathFromPosToPos_ZicZac() {
        ...
        PathList result = new Pathfinder().getPathFromPosToPos(new Position(0,0), new Position(2,2),
                                                               board);
    ...
    public void testGetPathFromPosToPos_Valid_Across() {
        ...
        PathList result = new Pathfinder().getPathFromPosToPos(new Position(0,0), new Position(4,4),
                board);
    ...
    public void testGetPathFromPosToPos_Valid_SamePos() {
        ...
        PathList result = new Pathfinder().getPathFromPosToPos(new Position(0,0), new Position(0,0),
                board);
