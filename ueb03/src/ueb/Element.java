package ueb;
/**
 * Diese Klasse beschreibt eine verkettete Liste enthalten mit
 *      value: char
 *      next:element
 *
 * @author hs, Nima, Max
...
public class Element {
     ...
     * Wird als Index die Listenlänge angegeben, so wird das neue Element an die Liste angehängt.
     * Wurde ein falscher Index übergeben, werden das Element und die folgenden unverändert zurückgegeben.
     *
     * @param value der einfügende Wert
     * @param index position an der eingefügt wird
     * @return die veränderte Liste
     * @author Nima, Max
     */
    Element insertElementAt(char value, int index) {
        if (index == 0) {
